<!-- Search Form -->
<div class="max-w-7xl mx-auto sm:px-6 lg:px-8 font-semibold text-2xl text-gray-800 dark:text-gray-200 leading-tight py-4">
    <form 
        method="POST" 
        ...
        <div class="flex flex-row items-center gap-1">
            <div x-data="{isOpen: false, results: [], searchTerm: '' }" class="relative w-full" @click.away="isOpen = false">
                <x-airport-search-input
                    ...
                    name="origin"
                    type="text"
                    class="w-full form-control py-4 px-5 rounded-l-xl"
                    placeholder="Origin"
                    autocomplete="off"
                    x-model="searchTerm"
